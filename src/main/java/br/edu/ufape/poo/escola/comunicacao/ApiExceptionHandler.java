...
public class ApiExceptionHandler {
	...
	@ExceptionHandler(DataFrequenciaInvalidaException.class)
	public ResponseEntity<ErroApi> dataFrequenciaInvalida(DataFrequenciaInvalidaException ex) {
		return resposta(HttpStatus.BAD_REQUEST, ex.getMessage(), Map.of());
	}

	@ExceptionHandler(FrequenciaJaRegistradaException.class)
	public ResponseEntity<ErroApi> frequenciaDuplicada(FrequenciaJaRegistradaException ex) {
		return resposta(HttpStatus.CONFLICT, ex.getMessage(), Map.of());
	}

	@ExceptionHandler(JustificativaInvalidaException.class)
	public ResponseEntity<ErroApi> justificativaInvalida(JustificativaInvalidaException ex) {
		return resposta(HttpStatus.CONFLICT, ex.getMessage(), Map.of());
	}
